...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div id="info_modal" class="modal" tabindex="-1" role="dialog">
            <div id="info_modal_dialog" class="modal-dialog fade" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="info_modal_title" class="modal-title">undefined</h5>
                        <button type="button" class="btn btn-light" onclick="HideModal()"><i class="fas fa-fw fa-times"></i></button>
                    </div>
                    <div id="info_modal_body" class="modal-body">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" onclick="HideModal();">Voltar</button>
                    </div>
                </div>
            </div>
        </div>
